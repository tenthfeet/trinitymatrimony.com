        ...
        <div class="container py-lg-5">
            <div class="ab-section text-center">
                ...
                <p class="py-3 mb-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Harum labore sed, veniam
                    nisi sunt laboriosam ducimus, odio
        ...
        <div class="container py-lg-5">
            <div class="row">
                ...
                <div class="col-lg-6 content-6-right mt-lg-0 mt-4">
                    <p class="mb-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Harum labore sed,
                        veniam nisi sunt laboriosam ducimus, odio
                        aspernatur fugiat minima blanditiis dignissimos.</p>
                    <p class="mb-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Harum labore sed,
                        veniam nisi sunt laboriosam ducimus, odio
                        aspernatur fugiat minima blanditiis dignissimos.</p>
		  ...
		  <div class="container py-lg-5">
			...
			<div class="row">
			  <div class="col-lg-3 col-6 mt-lg-5 mt-4">
				<div class="box16">
				  <a href="#url"><img src="{{asset('images/team1.jpg')}}" alt="" class="img-fluid" /></a>
			  ...
			  <div class="col-lg-3 col-6 mt-lg-5 mt-4">
				<div class="box16">
				  <a href="#url"><img src="{{asset('images/team2.jpg')}}" alt="" class="img-fluid" /></a>
				  <div class="box-content">
			  ...
			  <div class="col-lg-3 col-6 mt-lg-5 mt-4">
				<div class="box16">
				  <a href="#url"><img src="{{asset('images/team3.jpg')}}" alt="" class="img-fluid" /></a>
				  <div class="box-content">
			  ...
			  <div class="col-lg-3 col-6 mt-lg-5 mt-4">
				<div class="box16">
				  <a href="#url"><img src="{{asset('images/team4.jpg')}}" alt="" class="img-fluid" /></a>
				  <div class="box-content">
