    ...
    <section class="w3l-about-breadcrumb text-left">
        <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
            <div class="container py-2">
                <h2 class="title">Viewed Profiles</h2>
                <ul class="breadcrumbs-custom-path mt-2">
                    <li><a href="{{ url('/') }}">Home</a></li>
                    <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span>Viewed Profiles
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section id="search_div" class="w3l-grids-3" style="background-color: white;">
        <div class="container py-md-5">
            <div class="title-content text-left mb-lg-5 mb-4">
                <h3 class="title text-theme">Viewed Profiles</h3>
            </div>
